...
get_header(); ?>
	...
	<div id="content_item">
	   ...
	   <span class="left"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/salad_bottle_upright.png" alt="Glass bottle filled with red liquid with the word salad etched on the side."/></span>
	   ...
	   <span class="center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/etching_supplies.png" alt="Contact Paper, Armour Etch, Glass Bottle, Exacto Knife, and Stickers"/></span>
	  ...
	  <span class="left"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/contact_bottle.png" alt="Stripped contact paper covering a bottle"/></span>
		  <p>Next apply the stickers to the contact paper. I choose to spell salad, but you could use any word you'd like.</p>
	  <span class="right"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/stickers.png" alt="The word Salad spelled out with stickers in the side of a bottle covered with contact paper."/></span>	
	 ...
	 <span class="center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/salad_cut.png" alt="The word salad cut out of contact paper on glass bottle."/></span>       
	<p>Now it's time to use the Armour Etch. <strong>Note:</strong> Please follow all the safety precautions and directions on the Armour Etch or any glass etching cream you use. Following the directions on the armour etch, put on safety gloves and use the paint brush to apply a liberal amount of etching cream, covering the letters. Rinse off the paint brush and allow the cream to set for 60 <i>seconds</i>. Immediately rinse the entire bottle off in the sink. Wipe the bottle dry and remove the contact paper.</p>
	 <span class="center"><span class="right-padded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/etching_cream.png" alt="Etching cream on bottle."/></span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/final_etch.png" 		       alt="The word Salad etched on to the side of a glass bottle."/></span>
	...
	<span class="center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/salad_bottle/finished_bottle.png" alt="Glass bottle filled with red liquid with the word Salad etched on the side."/></span>
        <p>Click <a href="crafts.html">Here</a> for more great craft ideas!</p>
        </div>
	<div id="content_item">
	   <h2>8-26-2012</h2>
	   <h1>Authentic Southern French Crepe</h1>
	   <span class="left"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/crepe_small.png" alt="Strawberry and Whipped Cream Crepe on a Garnished Plate"/></span>
	    ...
	    <span class="center"><span class="right-padded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/crepe_ingredients.png" alt="Ingredients crepe, Flour, Fresh Strawberries, Fat Free Milk, Salt, Vanilla Extract, Eggs, and Captian Morgan's Rum"/></span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/crepe_supplies.png" alt="Bowl, Measure cups, Spatula, Whisk, and Skillet"/></span>
	<div class="left">
		<h2>Ingredients:</h2>
		 <ul>
	...
	<span class="center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/flour_crater.png" alt="Flour shaped into a crater inside a teal bowl." /></span>
	...
	<span class="center"><span class="right-padded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/eggs_in_flour.png" alt="Three eggs, yolks and whites, inside flour crater in teal bowl."/></span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/milk_eggs.png" alt="Eggs and Milk inside flour crater"/></span>
		...
		<span class="right"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/addingsalt.png" alt="Hand holding a pinch of salt over a bowl of crepe mix"/></span>
		...
		<span class="left"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/rum.png" alt="Pouring a capful of rum into a crepe mixture"/></span>
		...
		<span class="center"><span class="right-padded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/start_crepe.png" alt="Crepe cooking in skillet"/></span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/crepe_flip.png" alt="flipped crepe in skillet"/></span>
	</ol>
	...
	<span class="center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/toppings.png" alt="Crepes, strawberries, whipped cream, chocolate sauce, maple syrup, nutella, and a plate sitting on top of a brown table"/></span>
	...
	<span class="center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/crepe/strawberry_crepe.png" alt="Crepe filled with strawberries and topped with whipped cream and more strawberries sitting on a plate garnished with chocolate sauce."/></span>
