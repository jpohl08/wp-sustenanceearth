...
function twentyeleven_content_nav( $nav_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<nav id="<?php echo $nav_id; ?>">
            ...
            <?php if ( get_next_posts_link() && get_previous_posts_link() ) echo '<span class="sep"> | </span>'; ?>
...
function twentyeleven_posted_on() {
	printf( __( '<h2><time class="entry-date" datetime="%1$s" pubdate>%2$s</time></h2>', 'twentyeleven' ),
